...
from ipywidgets import FloatText, IntText, VBox, HBox, Box, Layout, Textarea, Button, Label, Dropdown, Text, Checkbox, HTML, Tab
...
def apply_placement_defaults(el: 'SequenceElement'):
    ...
    # 3) Pulse rules (channel-sensitive) – keep your prior logic
    if kind == "pulse":
        if base == "p0.txt":
            el.name = "p0"
        elif base == "p90.txt":
...
phase_cycle_output = Textarea(
    layout=Layout(width="420px", height="160px")
)
